                    ...
                    <FormControl>
                      <div className="relative group">
                        ...
                        <Button
                          ...
                          variant="ghost"
                          size="sm"
                          className="absolute right-2 top-1/2 transform -translate-y-1/2 h-8 w-8 rounded-lg hover:bg-white/10 text-white/30 hover:text-white/60 transition-all duration-300"
